...
**Watch for replica lag** — reads from replicas may return slightly stale data. This is acceptable for analytics, feeds, and searches; not acceptable for "read-your-own-writes" scenarios.
