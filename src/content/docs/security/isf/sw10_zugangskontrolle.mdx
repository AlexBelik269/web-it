---
title: "ISF – SW05: Zugangskontrolle – Authentisierung, Autorisierung & Token"
...
# Zugangskontrolle: Authentisierung, Autorisierung & Token
...
### 2.2 Challenge-Response mit symmetrischer Kryptographie
...
### 2.3 Challenge-Response mit asymmetrischer Kryptographie
...
### 2.4 Authentisierung mit Zertifikat
...
### 5.2 Login mit TOTP (zeitbasierter OTP)
...
### 5.3 Login mit Challenge-Response (manuell)
...
### 5.4 Login mit Challenge-Response (vollautomatisch)
...
### 6.1 Überblick der Angriffsarten
...
### 6.2 Retefe – Ein reales Angriffsszenario
...
### 6.3 Vorsicht: Credential-Verteilung
...
### 6.4 Vorsicht: Credential Recovery
...
### 7.1 Authentisierung (Login) vs. Autorisierung (Transaktion)
...
### 7.2 Schwachstelle: mTAN-Login – keine Transaktionsbindung
...
### 7.3 Transaktionssignierung: mTAN (richtig)
...
### 7.4 Transaktionssignierung: C/R manuell – Blind Signing
...
### 7.5 Vergleichsmatrix: Schutz gegen Angriffsarten
...
### 8.2 Rollenbasierte Autorisierung (RBAC)
...
### 8.3 Risikoabhängige Autorisierung im e-Banking
