...
<Aside type="tip">
The CSP nonce pattern allows your own inline scripts while blocking injected scripts from XSS attacks. Each request gets a unique random nonce — only scripts tagged with that nonce will execute.
</Aside>
