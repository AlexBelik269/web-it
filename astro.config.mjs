            ...
            */
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        collapsed: true,
                        items: [
                            { label: '1. Einführung', slug: 'security/introl/01_einfuehrung' },
                            { label: '2. Open Your Mind', slug: 'security/introl/02_open_your_mind' },
                            { label: '3. Cracking Lab', slug: 'security/introl/03_cracking_lab' },
                            { label: '4. Netzwerk-Analyse', slug: 'security/introl/04_netzwerk_analyse' },
                            { label: '5. Protokollanalyse', slug: 'security/introl/05_protokollanalyse' },
                            { label: '6. Man in the Middle', slug: 'security/introl/06_man_in_the_middle' },
                            { label: '7. Physische Sicherheit', slug: 'security/introl/07_physische_sicherheit' },
                            { label: '8. Firewall Basics I', slug: 'security/introl/08_firewall_technologien' },
                            { label: '9. Firewall Basics II', slug: 'security/introl/09_firewall_basics' },
                            { label: '10. Firewall Advanced', slug: 'security/introl/10_firewall_advanced' },
                            { label: '11. IPv6 Grundlagen', slug: 'security/introl/11_ipv6_grundlagen' },
                            { label: '12. IPv6 Lab', slug: 'security/introl/12_ipv6_lab' },
                        ],
                    },
                    {
                        label: 'ISF',
                        collapsed: true,
                        items: [
                            { label: '1. Grundlagen', slug: 'security/isf/01_einfuehrung' },
                            { label: '2. Awareness', slug: 'security/isf/02_awareness' },
                            { label: '3. Grundlagen Kryptologie', slug: 'security/isf/03_grundlagen_kryptologie' },
                            { label: '4. Kryptologishe Verfahren', slug: 'security/isf/04_kryptologische_verfahren' },
                            { label: '5. Protokolle Anwendung', slug: 'security/isf/05_protokolle_anwendungen' },
                            { label: '6. ISMS & Standards', slug: 'security/isf/06_isms_standards' },
                            { label: '7. Risiko Management', slug: 'security/isf/07_risiko_management' },
                            { label: '8. Zugangskontrolle', slug: 'security/isf/08_zugangskontrolle' },
                            { label: '9. Vulnerabilities', slug: 'security/isf/09_vulnerabilities' },
                        ],
                    },
                ],
            },
