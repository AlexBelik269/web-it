			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{
							label: 'INTROL - Introduction to Security Lab',
							collapsed: true,
							items: [
								{ label: 'SW01: Einführung', slug: 'security/introl/sw01_einfuehrung' },
								{ label: 'SW02: Open Your Mind', slug: 'security/introl/sw02_open_your_mind' },
								{ label: 'SW03: Cracking Lab', slug: 'security/introl/sw03_cracking_lab' },
								{ label: 'SW04: Netzwerk-Analyse mit Wireshark', slug: 'security/introl/sw04_netzwerk_analyse_wireshark' },
								{ label: 'SW05: Protokollanalyse', slug: 'security/introl/sw05_protokollanalyse' },
								{ label: 'SW06: Man in the Middle', slug: 'security/introl/sw06_man_in_the_middle' },
								{ label: 'SW07: Physische Sicherheit', slug: 'security/introl/sw07_physische_sicherheit_schloesser_schluessel' },
								{ label: 'SW08: Firewall Grundlagen', slug: 'security/introl/sw08_firewall_grundlagen' },
								{ label: 'SW09: Firewall Basics', slug: 'security/introl/sw09_firewall_basics' },
								{ label: 'SW10: Firewall Advanced', slug: 'security/introl/sw10_firewall_advanced' },
								{ label: 'SW11: IPv6 Grundlagen', slug: 'security/introl/sw11_ipv6_grundlagen' },
								{ label: 'SW12: IPv6 Adressierung, Routing und Tunneling', slug: 'security/introl/sw12_ipv6_adressierung_routing' },
							],
						},
						{
							label: 'ISF - Information Security Fundamentals',
							collapsed: true,
							items: [
								{ label: 'SW01: Begriffe & Common Ground', slug: 'security/isf/sw01_begriffe_commonground' },
								{ label: 'SW02: Awareness', slug: 'security/isf/sw02_awareness' },
								{ label: 'SW03: Intercepten', slug: 'security/isf/sw03_intercepten' },
								{ label: 'SW04: Intro Kryptographie', slug: 'security/isf/sw04_intro_kryptographie' },
								...
								{ label: 'SW07: Protokolle', slug: 'security/isf/sw07_protokolle' },
								{ label: 'SW08: ISMS & Standards', slug: 'security/isf/sw08_isms_standards' },
								{ label: 'SW09: Risiko Management', slug: 'security/isf/sw09_risiko_management' },
								{ label: 'SW10: Zugangskontrolle', slug: 'security/isf/sw10_zugangskontrolle' },
								{ label: 'SW11: Vulnerabilities', slug: 'security/isf/sw11_vulnerabilities' },
							],
						},
					],
				},
